            ...
            <div className="md:flex">
                ...
                <div>
                    <div className="p-8">
                        ...
                        <h4 className="product-subtitle">What are the benefits?</h4>
                        <ol>
                            <li>1 - Learn to create your own trading system.</li>
                            <li>2 - Learn to create your own trading robot.</li>
                            <li>3 - Learn to automate your trading strategy.</li>
                        </ol>

                        <p className="product-subtitle">Price : $350 | One-time payment </p>
                        <p className="product-subtitle">Program durarion : 1 Month</p>
                        <button className="border-2 border-red-500 bg-red-500 text-white py-2 px-10 rounded-lg text-lg mt-6">I&apos;m interested</button>
                    </div>
                </div>
            </div>
        </div>
