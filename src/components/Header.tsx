  ...
  return (
    ...
    <header className="h-screen bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
        ...
        <div className="px-[8%]">
          ...
          <button className="border-2 border-red-500 bg-red-500 text-white py-2 px-10 rounded-lg text-lg mt-12 mb-5">Create a synthetic account</button>
          <br />
          <button className="border-2 border-red-500 bg-red-500 text-white py-2 px-10 rounded-lg text-lg mb-5">Create a Forex account</button>
          <p className="text-white text-lg mt-10 mb-5">New to trading? Take advantage of our free trading education modules.</p>
          <button className="border-2 border-red-500 bg-red-500 text-white py-2 px-10 rounded-lg text-lg">Learn</button>
        </div>
    </header>
  )
}
