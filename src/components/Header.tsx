...
export default function Header() {
  return (
    ...
    <header className="min-h-screen bg-[url('/image/a-big-stock-trading.png')] bg-no-repeat bg-center bg-cover from-slate-900 via-indigo-900 to-slate-900">
        <Navbar />
        <div className="min-h-screen bg-gray-950/75 px-[8%]">
          ...
          <button className="border-2 border-rose-600 bg-rose-600 text-white py-2 px-10 rounded-lg text-lg mb-10">Learn</button>
        </div>
    </header>
  )
}
