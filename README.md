...
```sh
  cd my-folder
  git https://github.com/Matthieu96Code/trading-corp.git
```
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/trading-corp/issues).
...
I would like to thank [Web dev]()  for the great resources shared.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
